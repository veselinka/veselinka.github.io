...
// function biggestFromThree(args) {
// 	var a=+args[0];
// 	var b=+args[1];
// 	var c=+args[2];
// 		if (a >= b && a >= c) {
...
// 				console.log(firstDigit[first] + " hundred and " + thirdDigit[second * 10 + third]);
// 		}
// 		else{
// 			console.log(firstDigit[first] + " hundred and " +secondDigit[second]+" "+thirdDigit[third]);
// 		}
// };
// numberAsWord(0);
// numberAsWord(9);
...
function numberAsWord(args) {
		...
		var second = parseInt((number / 10) % 10);
		var third = parseInt(number % 100 % 10);
		var firstDigit = [" ", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"];
		var secondDigit = [" ", " ", "twenty", "thirty", "forty", "fifty", "sixty", "seventy", "eighty", "ninety"];
		var thirdDigit = [" ", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"];
		if (number === 0) {
				console.log("Zero");
			...
			var result = thirdDigit[second * 10 + third];
			console.log(result.charAt(0).toUpperCase() + result.slice(1));
		}
		else if (number >=20 && number <= 99) {
			var res = secondDigit[second] + " " + thirdDigit[third];
			console.log(res.charAt(0).toUpperCase() + res.slice(1));
		}
		else if(number >=100 && number <= 999){
			if((second * 10 + third)===0){
				var r=firstDigit[first] + " hundred";
				console.log(r.charAt(0).toUpperCase() + r.slice(1));
			}
			else if((second * 10 + third)<=19){
				var re=firstDigit[first] + " hundred and " + thirdDigit[second * 10 + third];
				console.log(re.charAt(0).toUpperCase() + re.slice(1));
			}
			else{
				var rrr = firstDigit[first] + " hundred and " +secondDigit[second]+" "+thirdDigit[third];
				console.log(rrr.charAt(0).toUpperCase() + rrr.slice(1));
			}
		}
		else{
